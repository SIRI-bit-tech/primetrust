...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_type', models.CharField(choices=[('transaction', 'Transaction'), ('security', 'Security'), ('account', 'Account'), ('investment', 'Investment'), ('loan', 'Loan'), ('bill', 'Bill'), ('system', 'System')], max_length=20)),
                ('priority', models.CharField(choices=[('low', 'Low'), ('medium', 'Medium'), ('high', 'High'), ('urgent', 'Urgent')], default='medium', max_length=10)),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'is_read'], name='notificatio_user_id_a4dd5c_idx'), models.Index(fields=['notification_type', 'created_at'], name='notificatio_notific_4b40ec_idx')],
            },
        ),
        migrations.CreateModel(
            name='SearchLog',
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'search_type'], name='search_logs_user_id_6e9cbe_idx'), models.Index(fields=['created_at'], name='search_logs_created_1842c5_idx')],
            },
        ),
        migrations.AddIndex(
