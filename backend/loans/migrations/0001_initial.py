# Generated by Django 5.2.4 on 2025-07-26 00:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'db_table': 'loans',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'status'], name='loans_user_id_efac20_idx'), models.Index(fields=['loan_type', 'status'], name='loans_loan_ty_7d36ad_idx')],
            },
        ),
    ]
