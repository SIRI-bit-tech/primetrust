...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='PrimeTrust <noreply@jimnetwork.org>')
...
if not DEBUG:
    ...
    # Required for cross-domain cookies (frontend and backend on different Render domains)
