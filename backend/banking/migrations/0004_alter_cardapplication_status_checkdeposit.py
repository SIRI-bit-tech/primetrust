# Generated by Django 4.2.22 on 2025-12-09 12:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('banking', '0003_bankaccount_account_number_hash_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='status',
            field=models.CharField(choices=[('processing', 'Processing'), ('approved', 'Approved'), ('declined', 'Declined'), ('completed', 'Completed')], default='processing', max_length=20),
        ),
